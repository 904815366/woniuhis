      ...
      <el-col :span="4">
        <div class="demo-image">
          <div class="block">
            ...
            <el-avatar v-if="avatar != null" shape="square" :size="200" :src="avatar" style="dispay:inline;">
            </el-avatar>
            <el-avatar v-if="avatar == null" shape="square" :size="200" style="dispay:inline;"
              src="https://cube.elemecdn.com/9/c2/f0ee8a3c7c9638a54940382568c9dpng.png"></el-avatar>

          </div>

          <el-upload class="upload-demo" action="#" accept=".jpg, .png" :auto-upload="false" :show-file-list="false"
      ...
      <el-col :span="8">
        <el-form :model="user" status-icon>
          <el-form-item label="姓名" prop="name" :label-width="formLabelWidth">
            <el-input readonly v-model="user.name" :style="inputWidth" autocomplete="off"></el-input>
          </el-form-item>
          ...
          <el-form-item label="年龄" prop="age" :label-width="formLabelWidth">
            <el-input readonly v-model="user.age" :style="inputWidth" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="身份证号" prop="card" :label-width="formLabelWidth">
            <el-input readonly v-model="user.card" :style="inputWidth" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item readonly label="联系电话" prop="phone" :label-width="formLabelWidth">
            <el-input readonly v-model="user.phone" :style="inputWidth" autocomplete="off"></el-input>
          </el-form-item>
          <el-form-item label="岗位" prop="roleid" :label-width="formLabelWidth">
            <span v-for="role in roleData">
              <el-input readonly v-if="role.id === user.roleid" v-model="role.name" :style="inputWidth"
                autocomplete="off" :key="role.id"></el-input>
            </span>
          </el-form-item>
          <el-form-item label="科室" prop="familyid" :label-width="formLabelWidth">
            <span v-for="family in familyData">
              <el-input readonly v-if="family.id === user.familyid" v-model="family.familyname" :style="inputWidth"
                autocomplete="off" :key="family.id"></el-input>
            </span>
          </el-form-item>
          <el-form-item label="级别" prop="level" :label-width="formLabelWidth">
            <el-input readonly v-model="user.level" :style="inputWidth" autocomplete="off"></el-input>
          </el-form-item>
        </el-form>
      </el-col>
      <el-col :span="8">
...
export default {
  ...
  methods: {
    ...
    uploadFile(item) {
      ...
      this.$axios.post('/api/user/uploadFile', formData).then(res => {
        this.reload();
        // this.$bus.on('avatarURL', this.getAvatarURL);
      }).catch(e => {
        console.log(e);
