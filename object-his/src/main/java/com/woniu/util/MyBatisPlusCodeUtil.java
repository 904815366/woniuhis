...
//    private static final String ENTITY_IGNORE_PREFIX="rbac_";
//
//    /**
//     * 启动方法
//     * @param args
...
//        try {
//            generator("lh",//作者
//                    "jdbc:mysql://127.0.0.1:3306/his?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai",
//                    "com.mysql.cj.jdbc.Driver",//数据库驱动
//                    "root",//数据库帐号
//                    "root",//数据库密码
//                    "com.woniu",//项目最大的包名
//                    "object-his",//项目名或项目模块名
//                    "appointment,arrange,bed,consutants,department,drug,drugrecord,family,moneyrecord,nurserecord,nursetype,patient,perms,refund,register,role,role_perms,user,ward,warn,warndetails");//要操作的表名,多个表名用逗号隔开
