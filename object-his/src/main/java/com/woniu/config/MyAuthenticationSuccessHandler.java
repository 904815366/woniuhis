...
//            opsForList.leftPush(, )
            ...
            String loginSuccessOfNameAndId = template.opsForValue().get("loginSuccessOfNameAndId");
...
//            System.out.println(newAuthoritiesStr);
            ...
            ResponseResult<String> result = new ResponseResult<>(strToken,loginSuccessOfNameAndId,200);
